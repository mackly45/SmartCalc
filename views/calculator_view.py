from PyQt6.QtWidgets import (QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, 
                             QPushButton, QLabel, QSizePolicy, QGridLayout, QFrame)
from PyQt6.QtCore import Qt, QSize, pyqtSignal, QRectF
from PyQt6.QtGui import QFont, QPixmap, QColor, QPainter, QPainterPath, QIcon, QResizeEvent
...
class CalculatorView(QMainWindow):
    ...
    def __init__(self):
        ...
        self.expression_display.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignBottom)
        ...
        for btn_text, row, col, row_span, col_span, style in buttons:
            ...
            if btn_text == '0':
                btn.setStyleSheet(btn.styleSheet() + "text-align: left; padding-left: 25px;")
