...
class AdvancedController(QObject):
    ...
    def plot_expression(self, expression: str, 
    ...
    def differentiate_expression(self, expression: str, 
                               variable: str = 'x', 
                               order: int = 1) -> None:
        """
    ...
    def integrate_expression(self, expression: str, 
                           variable: str = 'x', 
    ...
    def calculate_limit(self, expression: str, 
                       variable: str,
    ...
    def calculate_series(self, expression: str, 
                        variable: str,
                        point: float = 0, 
                        order: int = 5) -> None:
        """
