...
class AdvancedController(QObject):
    ...
    def __init__(self, model, view):
        ...
        self.model.matrix_operation_completed.connect(self.on_matrix_operation_completed)
    ...
    def setup_connections(self):
        ...
        if hasattr(self.view, 'matrix_determinant_button'):
            self.view.matrix_determinant_button.clicked.connect(self.on_matrix_determinant)
    ...
    def on_plot_updated(self, x, y):
        ...
        self.model.add_to_history(
            "Tracé de fonction",
            {"expression": self.view.get_expression(), "x_min": self.view.get_x_min(), "x_max": self.view.get_x_max()},
    ...
    def on_matrix_multiply(self):
        ...
        try:
            ...
            self.view.show_error(f"Erreur lors de la multiplication des matrices: {str(e)}")
